package id.ac.unhas.mytodo523.Fragment
...
import id.ac.unhas.mytodo523.Activity.MainActivity
import id.ac.unhas.mytodo523.Adapter.TaskList
import id.ac.unhas.mytodo523.Data.Task
import id.ac.unhas.mytodo523.Data.TaskViewModel
import id.ac.unhas.mytodo523.R
import id.ac.unhas.mytodo523.Utils.SwipeToDelete
import id.ac.unhas.mytodo523.databinding.FragmentMainBinding
...
class MainFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val taskListAdapter = TaskList(requireContext(), taskViewModel)
    ...
    private fun enableSwipeToDeleteAndUndo(taskListAdapter: TaskList) {
        val swipeToDeleteCallback = object : SwipeToDelete(context) {
